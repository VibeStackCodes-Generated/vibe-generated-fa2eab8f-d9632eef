 ...
 * Supports multiple variants and optional dismiss functionality
 */
function Alert({
  children,
  variant = 'info',
  ...
  const variantStyles = {
    ...
    warning: {
      container: 'bg-orange-50 border border-orange-200 dark:bg-orange-900/20 dark:border-orange-800',
